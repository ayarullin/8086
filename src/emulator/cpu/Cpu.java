...
//					case 6:
			...
			case (byte) 0x8E: // MOV Sw Ew
				...
				break;
			case (byte) 0xA0: // MOV AL Ob
				state.setAL(mem.getByte((state.getDS() << 4) + (nextWord() & 0xffff)));
				break;
			case (byte) 0xA1: // MOV AX Ov
				state.setAX(mem.getWord((state.getDS() << 4) + (nextWord() & 0xffff)));
				break;
